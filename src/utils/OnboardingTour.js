...
const ALL_STEPS = [
  ...
  { tab: 'Игра', icon: '🎮', title: 'Карточная игра', desc: 'При регистрации вам уже выдан стартовый набор из 10 карт! Нажмите «⚔️ Бой с боссом» — карты выходят на стол и бьются друг с другом, а цель — снять все жизни босса.' },
]
